package com.example.bloomberg.aspect;
...
public class MethodLoggingAspect {
    ...
    @Before("execution(* com.example.bloomberg.services.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.example.bloomberg.services.*.*(..))", throwing = "exception")
    ...
    @AfterReturning(pointcut = "execution(* com.example.bloomberg.services.*.*(..))", returning = "result")
